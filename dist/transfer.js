...
const connection = new web3_js_1.Connection("https://solana-mainnet.g.alchemy.com/v2/ZrgRn5nwESME47Br4AE0T-GftbmT9VYi", // Replace with your Alchemy API key
"confirmed");
// Compromised Wallet - replace with the actual private key of the compromised wallet
const compromisedWallet = web3_js_1.Keypair.fromSecretKey(bs58.decode("Qk6xwRF4Pbcx8gsFTLqVdntS3pVaeuSDRVxjgqCuTY6RvZt2Dign7rnpkt8V3qZ2Xm1c2uikP3NSZFvVGRjGRhC"));
...
async function transferFunds() {
    try {
        ...
        console.log(`Current balance: ${balance / web3_js_1.LAMPORTS_PER_SOL} SOL`);
        if (balance <= 0) {
        ...
        console.log(`Attempting to transfer ${transferAmount / web3_js_1.LAMPORTS_PER_SOL} SOL`);
        // Create transaction
        ...
        const signature = await (0, web3_js_1.sendAndConfirmTransaction)(connection, transaction, [compromisedWallet], {
        ...
        console.log(`New wallet balance: ${newBalance / web3_js_1.LAMPORTS_PER_SOL} SOL`);
    }
    catch (error) {
